...
const PreviewComponent = ({ estimateId, onClose }) => {
  ...
  const calculateVATIncluded = (item) => calculateSubtotal(item) * 1.1;
  ...
  const vatAmountCalc = Math.floor(
    (supplyAmountCalc - discountAmountCalc) * 0.1
  );
  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <strong>총 견적금액: {totalAmountCalc.toLocaleString()}원</strong>
        </li>
      </ul>
